...
class SampleListener(Leap.Listener):
    ...
    def on_frame(self, controller):
        ...
        back_5_frame = controller.frame(5)
        frames = [frame, previous_frame, back_frame, back_5_frame]

        #print frame.id, frame.timestamp, frame.hands.leftmost.fingers[3].bone(3).center
